...
I'm a second-year BTech student currently diving deep into the realms of Linux, programming, and mathematical finance. I am interested in exploring machine learning, data science, and quantitative finance. I keep web dev away from me. Alongside my studies, I develop mobile apps on android 
...
- **Linux**: Proficient in Linux systems, including configuration, scripting, and troubleshooting


## >_ Programming Language 💻

- **Rust**: Skilled in Rust programming, focusing on efficient, multi-threaded applications.
- **C\C++**: Performance-critical applications and quantitative finance.
- **Python**: Data analysis, machine learning, and automation.
- **Java**: Proficient in Java for Android development, with experience in building mobile applications.
- **Dart**: Language for Flutter UI development.
- **Zsh Shell**: Experienced in Zsh shell scripting and customization for enhanced productivity.
...
## >_ Tools & Technologies 🛠️

- **System Architecture**: x86_64  
- **Operating Systems**: Linux (Arch & NixOS), Windows (8.1, 10, 11)
- **Development Environments**: Emacs, Nano, Spyder, JetBrains IDEs (IntelliJ IDEA, Android Studio, etc), 
